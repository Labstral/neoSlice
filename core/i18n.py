...
_FR: dict[str, str] = {
    ...
    "neogen.tooltip":       "neoGen — bibliothèque d'objets 3D à personnaliser, prêts à imprimer",
    "app.btn_carte":        "CARTE",
    "carte.tooltip":        "Personnalisateur de carte de visite — texte, logo, couleurs et slots de filament",
    "carte.pitch":          "Composez une carte de visite : texte, logo, couleurs. Chaque couleur devient un slot de filament à l'export.",
    "carte.open_editor":    "Ouvrir l'éditeur de carte",
    "carte.exported":       "Carte exportée : {n} slot(s) de couleur — chargez vos filaments dans le slicer.",
    "carte.litho_exported": "Lithophanie exportée : une seule matière translucide — imprimez en PLA blanc/naturel et rétroéclairez.",
    "carte.dans_scene":     "Carte ajoutée à la scène — choisissez vos paramètres, puis « Générer le 3MF ».",
    "carte.export_err":     "Export impossible : {msg}",
    "neogen.subtitle":      "Choisissez un objet dans la bibliothèque et personnalisez-le : il se charge dans le viewer, prêt à analyser et exporter. Porte-clés, badges, plaques, magnets, sous-verres, logos, vases, boîtes, supports, dés…",
    "neogen.placeholder":   "Ex. : un porte-clé avec écrit « Léa », 5 cm",
    "neogen.generate":      "Générer",
    "neogen.attach_logo":   "Joindre un logo (SVG)",
    "neogen.attach_image":  "Joindre une image (SVG / PNG)",
    ...
    "neogen.base_checking": "Vérification de la base d'objets…",
    "neogen.base_uptodate": "Base d'objets déjà à jour.",
    "neogen.base_done":     "Base {v} installée : {n} objet(s) mis à jour. Redémarrez neoSlice pour les voir dans neoGen.",
    ...
    "neogen.text_placeholder": "Texte sur la pièce (optionnel)",
    "neogen.engraved":      "Texte gravé (au lieu du relief)",
    "neogen.text_required": "Cette pièce a besoin d'un texte.",
    "neogen.image_required": "Joignez d'abord une image.",
    "neogen.building":      "Construction de la pièce…",
    "neogen.hors_plateau":  "Pièce trop grande pour le plateau de l'imprimante choisie : {dims}. Réduis les dimensions.",
    "neogen.ex_free1":      "un aimant pour le frigo",
    "neogen.ex_free2":      "un support de manette de jeu",
    "neogen.section":       "NEOGEN — GÉNÉRATION D'OBJETS",
    "neogen.ready":         "✓ neoGen est installé.",
    "neogen.install_pitch": "Bibliothèque de 50+ objets 3D personnalisables, prêts à imprimer : porte-clés, plaques, cartes de visite, lithophanies… Moteur dédié ~7,6 Go, 100 % local.",
    "neogen.install":       "Installer neoGen",
    "neogen.installing":    "Téléchargement…",
    "neogen.uninstall":     "Désinstaller",
    ...
    "neogen.pro_only":      "neoGen (bibliothèque d'objets 3D à personnaliser) est une fonctionnalité Pro.",
    ...
    "modules.neogen_pitch": "bibliothèque d'objets 3D à personnaliser, prêts à imprimer",
    ...
    "status.object_isolated":   "Objet isolé : {name} — réglages propres à cet objet",
    "status.overview_restored": "Vue d'ensemble — {n} objet(s) avec réglages propres · « Exporter » génère un seul 3MF avec toutes les modifications",
    "status.reinforce_applied": "{n} pièce(s) fragile(s) renforcée(s) automatiquement (parois + remplissage) · « Exporter » applique ces renforts par pièce",
    "status.reinforce_off":     "Renforcement automatique des pièces fragiles désactivé",
    ...
    "export.perobj_how":        "Comment exporter les objets ?",
    "export.btn_one_per_object": "Un fichier .3MF par objet",
    "export.btn_single_common": "Un seul 3MF (réglages communs)",
    "export.btn_cancel":        "Annuler",
    "export.batch_folder":      "Choisir le dossier d'export (un 3MF par objet)",
    "export.batch_done_title":  "Export par objet terminé",
    "export.batch_done_text":   "{n} objet(s) exporté(s) dans :\n{folder}",
    "export.batch_failures":    "Échecs ({n}) : {names}",
    "export.batch_status":      "{n} objet(s) exporté(s) séparément",
    "export.save_ensemble":     "Enregistrer le 3MF d'ensemble (réglages par objet)",
    "export.save_two_plates":   "Enregistrer le 3MF (2 plateaux)",
    "export.folder_per_plate":  "Dossier d'export (un 3MF par plateau)",
    "export.multiplate_sep_title": "Export multi-plateaux (fichiers séparés)",
    ...
    "analysis.skip_auto":   "Surplombs non analysés : pièce trop lourde pour cette machine (mode Auto).",
    "analysis.skip_lite":   "Surplombs désactivés (mode Économique).",
    "analysis.force_btn":   "Forcer l'analyse complète",
    ...
    "viewer.back_overview":     "↩ Vue d'ensemble",
    ...
    "viewer.frag_computing":    "Fragilité (calcul…)",
    ...
    "explain.tip":              "Voir ce que neoSlice a changé et pourquoi",
    "explain.header":           "CE QUE NEOSLICE A CHANGÉ",
    "explain.cat_quality":      "QUALITÉ",
    "explain.cat_walls":        "PAROIS",
    "explain.cat_shells":       "COQUES",
    "explain.cat_infill":       "REMPLISSAGE",
    "explain.cat_speed":        "VITESSES",
    "explain.cat_filament":     "FILAMENT",
    "explain.cat_finish":       "FINITION",
    "explain.cat_brim":         "ADHÉRENCE",
    "explain.cat_support":      "SUPPORTS",
    "explain.cat_litho":        "LITHOPHANIE",
    "explain.f_layer_h":        "Hauteur de couche",
    "explain.f_walls":          "Parois (murs)",
    "explain.f_wallgen":        "Générateur de parois",
    "explain.f_topshell":       "Couches du dessus",
    "explain.f_botshell":       "Couches du dessous",
    "explain.f_density":        "Densité de remplissage",
    "explain.f_pattern":        "Motif de remplissage",
    "explain.f_outer":          "Vitesse paroi extérieure",
    "explain.f_inner":          "Vitesse paroi intérieure",
    "explain.f_infillspd":      "Vitesse de remplissage",
    "explain.f_bridge":         "Vitesse des ponts",
    "explain.f_first":          "Vitesse 1ʳᵉ couche",
    "explain.f_nozzle":         "Température buse",
    "explain.f_bed":            "Température plateau",
    "explain.f_seam":           "Position de couture",
    "explain.f_ironing":        "Repassage",
    "explain.f_eleph":          "Compensation patte d'éléphant",
    "explain.f_xy":             "Compensation XY",
    "explain.r_layer_fine":     "Couches plus fines → meilleur état de surface et plus de détails.",
    "explain.r_layer_thick":    "Couches plus épaisses → impression plus rapide.",
    "explain.r_walls_frag":     "Zones fines détectées ({min_t} mm) → plus de parois pour que ça ne casse pas.",
    "explain.r_walls_strong":   "Ton objectif solidité → plus de parois pour renforcer la pièce.",
    "explain.r_walls_generic":  "Plus de parois = pièce plus solide et rigide.",
    "explain.r_wallgen":        "Arachne gère mieux les parois fines et d'épaisseur variable.",
    "explain.r_shells":         "Plus de couches solides dessus/dessous → surfaces pleines plus nettes et solides.",
    "explain.r_density_up":     "Remplissage plus dense → pièce plus solide.",
    "explain.r_density_down":   "Remplissage allégé → moins de matière et de temps.",
    "explain.r_pattern":        "Motif de remplissage adapté à ton objectif.",
    "explain.r_pattern_gyroid": "Gyroïde : résiste dans toutes les directions.",
    "explain.r_outer_slow":     "Paroi extérieure ralentie → meilleur état de surface.",
    "explain.r_speed_slow_mat": "Vitesse plafonnée au débit maximal que la buse peut extruder proprement à cette hauteur de couche (au-delà : sous-extrusion).",
    "explain.r_speed_fast":     "Vitesse augmentée : ton objectif privilégie la rapidité (dans les limites machine).",
    "explain.r_bridge_slow":    "Ponts ralentis à cause des surplombs → ils ne s'affaissent pas dans le vide.",
    "explain.r_first_slow":     "Première couche ralentie → meilleure accroche au plateau.",
    "explain.r_temp":           "Température réglée pour bien imprimer ton filament.",
    "explain.r_seam":           "Couture repositionnée pour la rendre plus discrète.",
    "explain.r_ironing":        "Repassage activé → surface du dessus lisse.",
    "explain.r_comp":           "Compensation dimensionnelle pour des cotes plus précises.",
    "explain.brim_title":       "Brim de {w} mm ajouté",
    "explain.brim_reason_stab": "Ta pièce a une petite base peu stable ; le brim l'empêche de se décoller en cours d'impression.",
    "explain.brim_reason_flat": "Grande surface à plat ; le brim limite le gondolage (warping) des bords.",
    "explain.brim_reason_generic": "Améliore l'accroche au plateau et évite le décollement.",
    "explain.support_title":    "Supports {kind} ajoutés",
    "explain.supp_tree":        "arborescents",
    "explain.supp_normal":      "classiques",
    "explain.r_support":        "Supports ajoutés pour soutenir les surplombs pendant l'impression.",
    "explain.prime_title":      "Tour de purge activée",
    "explain.r_prime":          "Nettoie la buse entre les couleurs → transitions propres en multicolore.",
    "explain.litho_title":      "Profil lithophanie imposé",
    "explain.litho_reason":     "Remplissage 100 %, 4 parois et parois lentes, pour une lumière parfaitement homogène.",
    ...
    "settings.auto_reinforce":  "Renforcer automatiquement les pièces fragiles",
    ...
    "licenses.sec_libs":        "Bibliothèques logicielles",
    ...
    "settings.perf_auto":            "Auto (recommandé)",
    "settings.perf_auto_desc":       "neoSlice décide pour chaque pièce : toutes les analyses quand la pièce est raisonnable pour votre machine ; sur une pièce très lourde, l'analyse des surplombs est désactivée et le panneau vous le dit, avec un bouton pour la forcer.",
    "settings.perf_full_desc":       "Toutes les analyses, sur toutes les pièces — même très lourdes. Peut être long sur un PC lent.",
    "settings.perf_lite_desc":       "L'analyse des surplombs est désactivée sur toutes les pièces. Réservé aux PC vraiment lents.",
    # Analyse de configuration complète (par domaine, modules IA compris)
    "settings.cfg_summary":       "Votre machine : {cores} cœurs · {ram} Go RAM ({avail} Go libres) · {gpu} · {disk} Go libres sur le disque",
    "settings.cfg_gpu_none":      "GPU non détecté",
    "settings.cfg_line_pieces":   "Analyse & optimisation de pièces",
    "settings.cfg_line_diag":     "Diagnostic IA (photo)",
    "settings.cfg_line_oen":      "Oen (assistant IA local, modèle ~5 Go)",
    "settings.cfg_line_neogen":   "neoGen (modèle local, ~9 Go)",
    "settings.cfg_diag_ok":       "Opérationnel : le modèle léger tourne bien sur ce processeur.",
    "settings.cfg_diag_slow":     "Fonctionnel mais lent sur ce processeur (quelques secondes de plus par photo).",
    "settings.cfg_oen_gpu":       "Optimal : réponses rapides sur votre GPU ({vram} Go de VRAM).",
    "settings.cfg_oen_cpu":       "Fonctionnel : réponses lentes, le modèle tournera sur le processeur (un GPU NVIDIA ≥ 6 Go accélérerait nettement).",
    "settings.cfg_oen_limit":     "Limite : {ram} Go de RAM, fermez les autres applications pendant l'utilisation d'Oen.",
    "settings.cfg_oen_no":        "Déconseillé : moins de 8 Go de RAM, le modèle ne tiendra pas en mémoire.",
    "settings.cfg_neogen_gpu":    "Optimal : le modèle de neoGen profitera pleinement de votre GPU.",
    "settings.cfg_neogen_cpu":    "Fonctionnel : modèle plus lourd qu'Oen, prévoir des temps de réponse longs sur processeur.",
    "settings.cfg_neogen_limit":  "Limite : {ram} Go de RAM, possible mais fermez tout le reste pendant l'utilisation.",
    "settings.cfg_neogen_no":     "Déconseillé : 16 Go de RAM recommandés pour le modèle local de neoGen.",
    "settings.cfg_disk_warn":     "⚠ Espace disque juste : ~15 Go nécessaires pour installer les modules Oen + neoGen ({disk} Go libres)",
    ...
    "cost.machine_price":            "Prix d'achat machine ({cur})",
    "cost.machine_price_tip":        "Prix payé pour l'imprimante (ex. 1200) — amorti sur sa durée de vie pour calculer l'usure horaire. Ce n'est PAS un tarif à l'heure.",
    ...
    "cost.row_wear_rate":            "Usure machine ({rate} {cur}/h)",
...
_EN: dict[str, str] = {
    ...
    "app.btn_neogen":       "NEOGEN",
    "neogen.tooltip":       "neoGen — library of customizable, ready-to-print 3D objects",
    "app.btn_carte":        "CARD",
    "carte.tooltip":        "Business card designer — text, logo, colors and filament slots",
    "carte.pitch":          "Design a business card: text, logo, colors. Each color becomes a filament slot on export.",
    "carte.open_editor":    "Open card editor",
    "carte.exported":       "Card exported: {n} color slot(s) — load your filaments in the slicer.",
    "carte.litho_exported": "Lithophane exported: a single translucent material — print in white/natural PLA and backlight it.",
    "carte.dans_scene":     "Card added to the scene — pick your settings, then \"Generate 3MF\".",
    "carte.export_err":     "Export failed: {msg}",
    "neogen.subtitle":      "Pick an object from the library and personalize it: it loads into the viewer, ready to analyze and export. Keychains, badges, plates, magnets, coasters, logos, vases, boxes, stands, dice…",
    "neogen.placeholder":   "E.g.: a keychain with “Lea” written on it, 5 cm",
    "neogen.generate":      "Generate",
    "neogen.attach_logo":   "Attach a logo (SVG)",
    "neogen.attach_image":  "Attach an image (SVG / PNG)",
    ...
    "neogen.base_checking": "Checking the object base…",
    "neogen.base_uptodate": "Object base already up to date.",
    "neogen.base_done":     "Base {v} installed: {n} object(s) updated. Restart neoSlice to see them in neoGen.",
    ...
    "neogen.text_placeholder": "Text on the part (optional)",
    "neogen.engraved":      "Engraved text (instead of raised)",
    "neogen.text_required": "This part needs a text.",
    "neogen.image_required": "Attach an image first.",
    "neogen.building":      "Building the part…",
    "neogen.hors_plateau":  "Part too large for the selected printer's build plate: {dims}. Reduce the dimensions.",
    "neogen.ex_free1":      "a fridge magnet",
    "neogen.ex_free2":      "a game controller stand",
    "neogen.section":       "NEOGEN — OBJECT GENERATION",
    "neogen.ready":         "✓ neoGen is installed.",
    "neogen.install_pitch": "Library of 50+ customizable, ready-to-print 3D objects: keychains, plates, business cards, lithophanes… Dedicated engine ~7.6 GB, 100% local.",
    "neogen.install":       "Install neoGen",
    "neogen.installing":    "Downloading…",
    "neogen.uninstall":     "Uninstall",
    ...
    "neogen.pro_only":      "neoGen (library of customizable 3D objects) is a Pro feature.",
    ...
    "modules.neogen_pitch": "library of customizable, ready-to-print 3D objects",
    ...
    "status.object_isolated":   "Isolated object: {name} — settings specific to this object",
    "status.overview_restored": "Overview — {n} object(s) with their own settings · “Export” builds a single 3MF with every change",
    "status.reinforce_applied": "{n} fragile part(s) auto-reinforced (walls + infill) · “Export” applies these per-part reinforcements",
    "status.reinforce_off":     "Automatic reinforcement of fragile parts disabled",
    ...
    "export.perobj_how":        "How should the objects be exported?",
    "export.btn_one_per_object": "One .3MF file per object",
    "export.btn_single_common": "A single 3MF (shared settings)",
    "export.btn_cancel":        "Cancel",
    "export.batch_folder":      "Choose the export folder (one 3MF per object)",
    "export.batch_done_title":  "Per-object export finished",
    "export.batch_done_text":   "{n} object(s) exported to:\n{folder}",
    "export.batch_failures":    "Failures ({n}): {names}",
    "export.batch_status":      "{n} object(s) exported separately",
    "export.save_ensemble":     "Save the combined 3MF (per-object settings)",
    "export.save_two_plates":   "Save the 3MF (2 plates)",
    "export.folder_per_plate":  "Export folder (one 3MF per plate)",
    "export.multiplate_sep_title": "Multi-plate export (separate files)",
    ...
    "analysis.skip_auto":   "Overhangs not analyzed: part too heavy for this machine (Auto mode).",
    "analysis.skip_lite":   "Overhangs disabled (Lite mode).",
    "analysis.force_btn":   "Force full analysis",
    ...
    "viewer.frag_computing":    "Fragility (computing…)",
    ...
    # ── "What neoSlice changed" (diff vs default profile) ──────────────────
    "explain.tip":              "See what neoSlice changed and why",
    "explain.header":           "WHAT NEOSLICE CHANGED",
    "explain.cat_quality":      "QUALITY",
    "explain.cat_walls":        "WALLS",
    "explain.cat_shells":       "SHELLS",
    "explain.cat_infill":       "INFILL",
    "explain.cat_speed":        "SPEEDS",
    "explain.cat_filament":     "FILAMENT",
    "explain.cat_finish":       "FINISH",
    "explain.cat_brim":         "ADHESION",
    "explain.cat_support":      "SUPPORTS",
    "explain.cat_litho":        "LITHOPHANE",
    "explain.f_layer_h":        "Layer height",
    "explain.f_walls":          "Walls",
    "explain.f_wallgen":        "Wall generator",
    "explain.f_topshell":       "Top shells",
    "explain.f_botshell":       "Bottom shells",
    "explain.f_density":        "Infill density",
    "explain.f_pattern":        "Infill pattern",
    "explain.f_outer":          "Outer wall speed",
    "explain.f_inner":          "Inner wall speed",
    "explain.f_infillspd":      "Infill speed",
    "explain.f_bridge":         "Bridge speed",
    "explain.f_first":          "First layer speed",
    "explain.f_nozzle":         "Nozzle temp",
    "explain.f_bed":            "Bed temp",
    "explain.f_seam":           "Seam position",
    "explain.f_ironing":        "Ironing",
    "explain.f_eleph":          "Elephant foot comp.",
    "explain.f_xy":             "XY compensation",
    "explain.r_layer_fine":     "Finer layers → nicer surface finish and more detail.",
    "explain.r_layer_thick":    "Thicker layers → faster print.",
    "explain.r_walls_frag":     "Thin zones detected ({min_t} mm) → more walls so it won't break.",
    "explain.r_walls_strong":   "Your strength goal → more walls to reinforce the part.",
    "explain.r_walls_generic":  "More walls = a stronger, stiffer part.",
    "explain.r_wallgen":        "Arachne handles thin and variable-width walls better.",
    "explain.r_shells":         "More solid top/bottom layers → cleaner, stronger solid surfaces.",
    "explain.r_density_up":     "Denser infill → a stronger part.",
    "explain.r_density_down":   "Lighter infill → less material and time.",
    "explain.r_pattern":        "Infill pattern matched to your goal.",
    "explain.r_pattern_gyroid": "Gyroid: strong in every direction.",
    "explain.r_outer_slow":     "Outer wall slowed → better surface finish.",
    "explain.r_speed_slow_mat": "Speed capped to the maximum the nozzle can extrude cleanly at this layer height (beyond that: under-extrusion).",
    "explain.r_speed_fast":     "Speed increased: your goal favors speed (within machine limits).",
    "explain.r_bridge_slow":    "Bridges slowed due to overhangs → they don't sag into empty space.",
    "explain.r_first_slow":     "First layer slowed → better bed adhesion.",
    "explain.r_temp":           "Temperature tuned to print your filament well.",
    "explain.r_seam":           "Seam repositioned to make it more discreet.",
    "explain.r_ironing":        "Ironing enabled → smooth top surface.",
    "explain.r_comp":           "Dimensional compensation for more accurate sizes.",
    "explain.brim_title":       "{w} mm brim added",
    "explain.brim_reason_stab": "Your part has a small, unstable base; the brim keeps it from detaching mid-print.",
    "explain.brim_reason_flat": "Large flat area; the brim limits edge warping.",
    "explain.brim_reason_generic": "Improves bed grip and prevents detaching.",
    "explain.support_title":    "{kind} supports added",
    "explain.supp_tree":        "Tree",
    "explain.supp_normal":      "Normal",
    "explain.r_support":        "Supports added to hold up overhangs during printing.",
    "explain.prime_title":      "Prime tower enabled",
    "explain.r_prime":          "Cleans the nozzle between colors → clean multicolor transitions.",
    "explain.litho_title":      "Lithophane profile applied",
    "explain.litho_reason":     "100% infill, 4 walls and slow walls, for perfectly even light.",
    ...
    "settings.auto_reinforce":  "Automatically reinforce fragile parts",
    ...
    "licenses.sec_libs":        "Software libraries",
    ...
    "settings.perf_auto":            "Auto (recommended)",
    "settings.perf_auto_desc":       "neoSlice decides per part: all analyses when the part is reasonable for your machine; on a very heavy part, overhang analysis is skipped and the panel tells you, with a button to force it.",
    "settings.perf_full_desc":       "All analyses, on every part — even very heavy ones. Can be slow on a slow PC.",
    "settings.perf_lite_desc":       "Overhang analysis is disabled on every part. For really slow PCs only.",
    # Full configuration analysis (per domain, AI modules included)
    "settings.cfg_summary":       "Your machine: {cores} cores · {ram} GB RAM ({avail} GB free) · {gpu} · {disk} GB free on disk",
    "settings.cfg_gpu_none":      "No GPU detected",
    "settings.cfg_line_pieces":   "Part analysis & optimization",
    "settings.cfg_line_diag":     "AI Diagnostic (photo)",
    "settings.cfg_line_oen":      "Oen (local AI assistant, ~5 GB model)",
    "settings.cfg_line_neogen":   "neoGen (local model, ~9 GB)",
    "settings.cfg_diag_ok":       "Operational: the lightweight model runs well on this CPU.",
    "settings.cfg_diag_slow":     "Works but slow on this CPU (a few extra seconds per photo).",
    "settings.cfg_oen_gpu":       "Optimal: fast answers on your GPU ({vram} GB VRAM).",
    "settings.cfg_oen_cpu":       "Works: slow answers, the model will run on the CPU (an NVIDIA GPU ≥ 6 GB would speed it up a lot).",
    "settings.cfg_oen_limit":     "Borderline: {ram} GB RAM, close other applications while using Oen.",
    "settings.cfg_oen_no":        "Not recommended: less than 8 GB RAM, the model won't fit in memory.",
    "settings.cfg_neogen_gpu":    "Optimal: neoGen's model will fully benefit from your GPU.",
    "settings.cfg_neogen_cpu":    "Works: heavier model than Oen, expect long response times on CPU.",
    "settings.cfg_neogen_limit":  "Borderline: {ram} GB RAM, possible but close everything else while using it.",
    "settings.cfg_neogen_no":     "Not recommended: 16 GB RAM recommended for neoGen's local model.",
    "settings.cfg_disk_warn":     "⚠ Low disk space: ~15 GB needed to install the Oen + neoGen modules ({disk} GB free)",
    ...
    "cost.filament_price":           "Filament ({cur}/kg)",
    "cost.machine_price":            "Machine purchase price ({cur})",
    "cost.machine_price_tip":        "Price paid for the printer (e.g. 1200) — amortised over its lifespan to compute hourly wear. This is NOT an hourly rate.",
    ...
    "cost.row_wear_rate":            "Machine wear ({rate} {cur}/h)",
