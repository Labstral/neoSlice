...
_FR: dict[str, str] = {
    ...
    "neogen.not_installed": "neoGen n'est pas installé. Rendez-vous dans les Paramètres (section NEOGEN) pour télécharger son moteur de génération (~9 Go) — indépendant de l'assistant Oen.",
    ...
    "neogen.ready":         "✓ neoGen est installé — bouton NEOGEN dans la barre du haut.",
    "neogen.install_pitch": "Générez des objets 3D en les décrivant en français : bibliothèque de 50+ objets personnalisables + création sur mesure. Moteur dédié ~9,3 Go, 100 % local.",
    "neogen.install":       "Installer neoGen (~9,3 Go)",
    "neogen.installing":    "Téléchargement…",
    "neogen.uninstall":     "Désinstaller neoGen",
    "neogen.uninstall_title": "Désinstaller neoGen",
    "neogen.uninstall_confirm": "Supprimer le moteur de génération neoGen (~9 Go) ? Vous pourrez le réinstaller à tout moment.",
    "neogen.pro_only":      "neoGen (génération d'objets par texte) est une fonctionnalité Pro.",
    "neogen.need_runtime":  "Installez d'abord l'assistant Oen (section ci-dessus) : neoGen utilise le même runtime IA local.",
...
_EN: dict[str, str] = {
    ...
    "neogen.not_installed": "neoGen is not installed. Go to Settings (NEOGEN section) to download its generation engine (~9 GB) — independent from the Oen assistant.",
    ...
    "neogen.ready":         "✓ neoGen is installed — NEOGEN button in the top bar.",
    "neogen.install_pitch": "Generate 3D objects by describing them: a library of 50+ customizable objects + custom creation. Dedicated engine ~9.3 GB, 100% local.",
    "neogen.install":       "Install neoGen (~9.3 GB)",
    "neogen.installing":    "Downloading…",
    "neogen.uninstall":     "Uninstall neoGen",
    "neogen.uninstall_title": "Uninstall neoGen",
    "neogen.uninstall_confirm": "Remove the neoGen generation engine (~9 GB)? You can reinstall it anytime.",
    "neogen.pro_only":      "neoGen (text-to-object generation) is a Pro feature.",
    "neogen.need_runtime":  "Install the Oen assistant first (section above): neoGen uses the same local AI runtime.",
