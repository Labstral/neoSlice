...
_FR: dict[str, str] = {
    ...
    "analysis.verdict_warn":"⚠  VÉRIFIER AVANT IMPRESSION",
    "analysis.verdict_bad": "⛔  PIÈCE COMPLEXE — ATTENTION",

    "analysis.status_floating":   "⛔ Régions flottantes — supports obligatoires",
    ...
    "analysis.status_stab_low":   "⚠ Stabilité faible — brim obligatoire",
    ...
    "tuto.5.body":  (
        "Trois raccourcis sont disponibles à tout moment :<br><br>"
    ...
    "pdf.bed_first":        "Textured PEI Plate — 1ère couche",
    "pdf.bed_other":        "Textured PEI Plate — autres couches",
    ...
    "pdf.verdict_warn":     "VÉRIFIER AVANT IMPRESSION",
...
_EN: dict[str, str] = {
    ...
    "analysis.verdict_warn":"⚠  CHECK BEFORE PRINTING",
    "analysis.verdict_bad": "⛔  COMPLEX PART — CAUTION",

    "analysis.status_floating":   "⛔ Floating regions — supports required",
    ...
    "analysis.status_stab_low":   "⚠ Low stability — brim required",
    ...
    "tuto.0.body":  (
        ...
        "This guide walks you through the 4-step workflow.\n"
    ...
    "tuto.5.body":  (
        "Three shortcuts are always available:<br><br>"
        "<table cellspacing='0' cellpadding='0' width='100%'>"
        "<tr><td width='28' valign='top' style='padding-top:1px;'>"
        "<span style='font-family:\"Segoe MDL2 Assets\";font-size:11pt;color:#E8F4FF;'>&#xE8BD;</span>"
    ...
    "pdf.bed_first":        "Textured PEI Plate — 1st layer",
    "pdf.bed_other":        "Textured PEI Plate — other layers",
    ...
    "pdf.verdict_warn":     "CHECK BEFORE PRINTING",
