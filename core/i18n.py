...
_FR: dict[str, str] = {
    ...
    "cost.kwh":                      "Tarif électricité (par kWh)",
    "cost.filament_price":           "Prix filament (par kg)",
    "cost.machine_price":            "Prix de la machine",
    "cost.machine_life":             "Durée de vie machine (h)",
    "cost.labor_rate":               "Taux horaire",
    "cost.failure":                  "Taux d'échec (%)",
    "cost.margin":                   "Marge bénéfice (%)",
    "cost.weight":                   "Poids (g)",
    "cost.time":                     "Durée d'impression (h)",
...
_EN: dict[str, str] = {
    ...
    "cost.filament_price":           "Filament price (per kg)",
    "cost.machine_price":            "Machine price",
    "cost.machine_life":             "Machine lifespan (h)",
    "cost.labor_rate":               "Hourly rate",
    "cost.failure":                  "Failure rate (%)",
    "cost.margin":                   "Profit margin (%)",
    "cost.weight":                   "Weight (g)",
    "cost.time":                     "Print time (h)",
