...
_FR: dict[str, str] = {
    ...
    "cost.quote_updated":            "Devis {number} mis à jour.",
    "cost.saved_quotes":             "Devis enregistrés",
    "cost.no_quotes":                "Aucun devis enregistré.",
    "cost.edit":                     "Modifier",
    "cost.edit_full":                "Rouvrir ce devis pour le modifier",
    "cost.update_quote":             "METTRE À JOUR LE DEVIS",
    "cost.editing_banner":           "Modification du devis {number}",
    "cost.cancel_edit":              "Annuler",
    ...
    "cost.section_channel":          "CANAL DE VENTE",
    "cost.channel_note":             "Commission d'un apporteur d'affaires ou d'une plateforme (Xometry…), en % du prix de vente. Le prix est automatiquement rehaussé pour conserver votre marge.",
    "cost.channel":                  "Canal de vente",
    "cost.commission":               "Commission (%)",
    "cost.channel_direct":           "Direct (aucune commission)",
    "cost.channel_apporteur":        "Apporteur d'affaires",
    "cost.channel_platform":         "Plateforme (Xometry…)",
    "cost.channel_other":            "Autre",
    "cost.commission_row":           "Commission ({pct} %)",
    "cost.reco_price":               "PRIX CONSEILLÉ (COMMISSION INCLUSE)",
    "cost.apporteur":                "Apporteur",
    "cost.apporteur_none":           "— Aucun —",
    "cost.apporteur_new":            "Nouvel apporteur",
    "app.intro":                     "Enregistrez vos apporteurs d'affaires et suivez le cumul des commissions générées par leurs devis.",
    "app.new":                       "Nouvel apporteur",
    "app.none":                      "Aucun apporteur enregistré. Ajoutez-en un, puis rattachez-le à un devis via la section « Canal de vente ».",
    "app.name":                      "Nom",
    "app.commission":                "Commission par défaut (%)",
    "app.email":                     "E-mail (facultatif)",
    "app.notes":                     "Notes",
    "app.save":                      "Enregistrer",
    "app.create_title":              "Nouvel apporteur",
    "app.edit_title":                "Modifier l'apporteur",
...
_EN: dict[str, str] = {
    ...
    "cost.quote_updated":            "Quote {number} updated.",
    "cost.saved_quotes":             "Saved quotes",
    "cost.no_quotes":                "No quotes saved yet.",
    "cost.edit":                     "Edit",
    "cost.edit_full":                "Reopen this quote to edit it",
    "cost.update_quote":             "UPDATE QUOTE",
    "cost.editing_banner":           "Editing quote {number}",
    "cost.cancel_edit":              "Cancel",
    ...
    "cost.section_channel":          "SALES CHANNEL",
    "cost.channel_note":             "Commission from a business introducer or a platform (Xometry…), as % of the sale price. The price is automatically raised to preserve your margin.",
    "cost.channel":                  "Sales channel",
    "cost.commission":               "Commission (%)",
    "cost.channel_direct":           "Direct (no commission)",
    "cost.channel_apporteur":        "Business introducer",
    "cost.channel_platform":         "Platform (Xometry…)",
    "cost.channel_other":            "Other",
    "cost.commission_row":           "Commission ({pct}%)",
    "cost.reco_price":               "RECOMMENDED PRICE (COMMISSION INCL.)",
    "cost.apporteur":                "Introducer",
    "cost.apporteur_none":           "— None —",
    "cost.apporteur_new":            "New introducer",
    "app.intro":                     "Register your business introducers and track the total commissions generated by their quotes.",
    "app.new":                       "New introducer",
    "app.none":                      "No introducer saved yet. Add one, then link it to a quote from the “Sales channel” section.",
    "app.name":                      "Name",
    "app.commission":                "Default commission (%)",
    "app.email":                     "Email (optional)",
    "app.notes":                     "Notes",
    "app.save":                      "Save",
    "app.create_title":              "New introducer",
    "app.edit_title":                "Edit introducer",
    "app.delete":                    "Delete",
