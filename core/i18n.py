...
_FR: dict[str, str] = {
    ...
    "oen.install_pitch":      "Oen, l'assistant IA local et hors ligne. Téléchargement unique (~2 Go) : moteur, modèle et base de connaissances.",
...
_EN: dict[str, str] = {
    ...
    "oen.install_pitch":      "Oen, the local, offline AI assistant. One-time download (~2 GB): engine, model and knowledge base.",
