...
_SYSTEM_PROMPT = (
    ...
    "Exemples : [[ACTION: add_client {\"nom\": \"Jean Dupont\", \"ville\": \"Geneve\", "
    "\"email\": \"j@ex.com\"}]] ; [[ACTION: add_quote {\"client\": \"Jean Dupont\", "
    "\"items\": [{\"designation\": \"Figurine\", \"qty\": 2, \"unit_price\": 15}]}]] .\n"
...
_GUARD = (
    ...
    "dans l'Espace Pro.\n"
    "- ACTION ATELIER (creer/modifier) : n'emets un marqueur [[ACTION: …]] QUE si TOUS les "
    "champs requis sont connus. Ne cree JAMAIS un devis/commande/element VIDE ni a 0 : s'il "
    "manque les ARTICLES (designation + prix + quantite) ou le CLIENT, DEMANDE-les d'abord, "
    "UNE info a la fois, SANS marqueur (un devis se construit en posant des questions, pas en "
    "le creant vide). N'INVENTE aucun montant/quantite. UNE seule action par message, et ne "
    "REJOUE pas une action deja faite (tu vois tes confirmations '✓' precedentes dans le fil).\n"
