...
> Version actuelle : **v0.1.5.4** — [Télécharger](https://neoslice-ai.com)
...
### Windows
1. Téléchargez `neoSlice_Setup_v0.1.5.4-beta_Windows.exe` sur [neoslice-ai.com](https://neoslice-ai.com)
