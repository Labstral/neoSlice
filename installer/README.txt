==============================================================================
  ...
  Guide d'installation et de démarrage - v0.1.5.5 Bêta
==============================================================================
...
------------------------------------------------------------------------------
  ...
  neoSlice_Setup_v0.1.5.5-beta_Windows.exe  ->  Installateur Windows
  README.txt                       ->  Ce guide
...
------------------------------------------------------------------------------
  ...
  ---------------------------------
  Double-cliquez sur : neoSlice_Setup_v0.1.5.5-beta_Windows.exe
