==============================================================================
  ...
  Guide d'installation et de démarrage - v0.1.5.6 Bêta
==============================================================================
...
------------------------------------------------------------------------------
  ...
  neoSlice_Setup_v0.1.5.6-beta_Windows.exe  ->  Installateur Windows
  README.txt                       ->  Ce guide
...
------------------------------------------------------------------------------
  ...
  ---------------------------------
  Double-cliquez sur : neoSlice_Setup_v0.1.5.6-beta_Windows.exe
