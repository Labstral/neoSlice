...
class SettingsDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        # Notice de redémarrage (cachée jusqu'au changement de langue)
        ...
        self._perf_test_btn.setFont(QFont("Segoe UI", 9))
    ...
    def _populate_printers(self):
        ...
        none_item.setFont(QFont("Segoe UI", 9))
    ...
    def _on_perf_mode_changed(self):
        PREFS.set("perf_mode", self._perf_combo.currentData())
    ...
    def _apply_theme(self):
        ...
        for lbl in (self._lbl_apparence, self._lbl_print, self._lbl_export, self._lbl_perf):
        ...
        combo_style = f"""
            QComboBox {{
                ...
                padding: 2px 8px; font-family: 'Segoe UI'; font-size: 9px;
            }}
