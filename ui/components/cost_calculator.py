...
class CostCalculatorDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        lbl_print.setFont(QFont(FONT_MAIN, 7, QFont.Bold))
        ...
        lbl_rates.setFont(QFont(FONT_MAIN, 7, QFont.Bold))
        ...
        flay.addLayout(self._row("cost.kwh", self._num_edit("kwh")))
        flay.addLayout(self._row("cost.filament_price", self._num_edit("filament")))
        flay.addLayout(self._row("cost.machine_price", self._num_edit("machine")))
        flay.addLayout(self._row("cost.machine_life", self._num_edit("life")))
        flay.addLayout(self._row("cost.labor_rate", self._num_edit("labor")))
    ...
    def _load_rates(self):
        ...
        for key in ("kwh", "filament", "machine", "life", "labor", "failure", "margin"):
    ...
    def _recompute(self):
        ...
        self._break_rows["electricity"][1].setText(f"{b.electricity:.2f} {cur}")
    ...
    def _export_pdf(self):
        self._save_rates()
        b = self._last
        default_name = f"devis_{self._part_name}".replace(" ", "_")[:40] + ".pdf"
